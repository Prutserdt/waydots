...
The vterm-toggle package. I keep it for a while during testing of ghostel.
#+BEGIN_SRC emacs-lisp :tangle packages.el :results silent
(package! vterm-toggle)
#+END_SRC

Ghostel is a emacs package for the ghostty terminal.
#+BEGIN_SRC emacs-lisp :tangle packages.el :results silent
(package! ghostel)
...
I changed the background to be inline with my overall theme.... FIXME: needs bettter implimentation
#+BEGIN_SRC emacs-lisp :tangle config.el :results silent
...
FIXME: hl-todo-mode is not functioning properly right now. TODO and 'TODO' is not highlighted and "TODO" is..
#+BEGIN_SRC emacs-lisp :tangle config.el :results silent
...
FIXME: improve this function! Barely working...
#+BEGIN_SRC emacs-lisp :tangle config.el :results silent
...
** Splash screen
A useless but pretty Emacs welcome screen is created including an image and some text based on the default Doom emacs welcome screen. It is so useless that I'm not using it anymore 🙂.
#+BEGIN_SRC emacs-lisp :tangle config.el :results silent
